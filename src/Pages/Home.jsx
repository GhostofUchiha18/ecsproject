...
function Home() {
  return (
    <>
            ...
            <div className="container mx-auto font-minion justify-center text-white font-bold items-center">
              <center>
                <img
                  ...
                  alt="Artwork"
                />
                <p className="lg:ml-80 lg:mr-80 mt-4 sm:items-center font-minion absolute top-[82%] xl:hidden">
      ...
      {/* <div class="hidden sm:block max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
